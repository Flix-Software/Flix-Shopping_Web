      ...
      <form action="index.php" method="post" name="adminForm" id="adminForm">
        ...
        <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
          <tr>
            ...
            <th align="left" class="title" width="60%"
              nowrap="nowrap"><?php echo HTML_os_cck::sort_head(JText::_('COM_OS_CCK_REQUEST_ENTITY'), 'entity', $sort_arr,JRequest::getVar('task'));?></th>
          </tr>
          <?php
...
//          var_dump($value);
//          var_dump($field->db_field_name . "_address");
