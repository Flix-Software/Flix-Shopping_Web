  ...
  static function showInstances($option){
    ...
    if (is_array($sort_arr = $session->get('eq_itemsort', ''))) {
      ...
      if(JRequest::getVar('sort','')){
          $sort_arr['field'] = JRequest::getVar('sort','');
          $item_sort_param = JRequest::getVar('sort','');
...
//    }
//    $quantity = NULL;
//    if(isset($_REQUEST['quantity_fields'])){
//      foreach ($_REQUEST['quantity_fields'] as $quantity) {
//        if(isset($data['fields_data'][$quantity])){
//          $quantity = $data['fields_data'][$quantity];
//        }
//      }
//    }
//
