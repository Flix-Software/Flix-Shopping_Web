...
class JFormFieldCartlayout extends JFormField{
  protected function getInput(){
    ...
    $link = JRoute::_('index.php?option=com_os_cck&task=manage_layout_modal&layout_type=cart&tmpl=component');
    $rel="{handler: 'iframe', size: {x: 900, y: 550}}";
    $lid = (isset($params->cart_layout) && !empty($params->cart_layout))? $params->cart_layout : '';
