...
//var_dump($value);
  ...
  <div class="instance-settings-block">
    <div class="settings-block">
      ...
      <div class="settings-content">
        <span class="col-1"><?php echo JText::_('COM_OS_CCK_LABEL_INSTANCE_TITLE')?>:</span>
        <span class="col-2">
          <input type="text" name="meta_title" value="<?php echo $entityInstance->meta_title; ?>">
        </span>
      </div>
      <div class="settings-content">
        <span class="col-1"><?php echo JText::_('COM_OS_CCK_LABEL_INSTANCE_DESCRIPTION')?>:</span>
        <span class="col-2">
          <input type="text" name="meta_description" value="<?php echo $entityInstance->meta_description; ?>">
        </span>
      </div>
      <div class="settings-content">
        <span class="col-1"><?php echo JText::_('COM_OS_CCK_LABEL_INSTANCE_KEYWORDS')?>:</span>
        <span class="col-2">
          <input type="text" name="meta_keywords" value="<?php echo $entityInstance->meta_keywords; ?>">
        </span>
      </div>
      <div class="settings-content">
        <span class="col-1"><?php echo JText::_('COM_OS_CCK_LABEL_INSTANCE_ROBOTS')?>:</span>
        <span class="col-2">
        ...
        <?php if($cck_entity_configuration[$entityInstance->fk_eid]['check_access_instances'] == '1'){ ?>
          <div class="settings-content">
            <span class="col-1"><?php echo JText::_("COM_OS_CCK_LABEL_FIELD_ACCESS")?></span>
