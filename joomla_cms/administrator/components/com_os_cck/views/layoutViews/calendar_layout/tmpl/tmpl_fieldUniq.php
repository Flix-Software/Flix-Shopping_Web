...
jQuerOs(document).ready(function() {
    ...
    jQuerOs('select[name^=fi_calendar_view_]').trigger('change');

    jQuerOs('select[name^=fi_calendar_view_]').unbind('change');
    jQuerOs('select[name^=fi_calendar_view_]').change(function(event) {

       if(jQuerOs(this).val() == 'small'){
            jQuerOs('[name=fi_calendar_table_event_title]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_output_format]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_output_header_format]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_show_time]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_show_header_date_time]').parent('div').slideUp();

            jQuerOs('[name=fi_calendar_table_schedule_instance_lid]').parent('div').slideUp();
            //jQuerOs('[name^=fi_calendar_table_link_field]').parent('div').slideUp();
       }else if(jQuerOs(this).val() == 'large'){
            jQuerOs('[name=fi_calendar_table_event_title]').parent('div').slideDown();
            jQuerOs('[name=fi_calendar_table_output_format]').parent('div').slideDown();
            jQuerOs('[name=fi_calendar_table_output_header_format]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_show_time]').parent('div').slideDown();
            jQuerOs('[name=fi_calendar_table_show_header_date_time]').parent('div').slideUp();

            jQuerOs('[name=fi_calendar_table_schedule_instance_lid]').parent('div').slideUp();
            //jQuerOs('[name^=fi_calendar_table_link_field]').parent('div').slideUp();
       }else if(jQuerOs(this).val() == 'schedule'){
            jQuerOs('[name=fi_calendar_table_event_title]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_output_format]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_output_header_format]').parent('div').slideDown();
            jQuerOs('[name=fi_calendar_table_show_time]').parent('div').slideUp();
            jQuerOs('[name=fi_calendar_table_show_header_date_time]').parent('div').slideDown();

            jQuerOs('[name=fi_calendar_table_schedule_instance_lid]').parent('div').slideDown();
            //jQuerOs('[name^=fi_calendar_table_link_field]').parent('div').slideDown();
       }
