...
$cck_search_field->field_type = 'search_field';
...
<?php 
      ...
      if($pricefield){ 
          $field = new stdClass;
          $field->label = JText::_("COM_OS_CCK_PRICE_FIELD_LABEL");
          $field->db_field_name = 'price_search';
          $field->field_type = 'price_search';
          $field->description = '';      
        ...
        <div class="field-block">
          <div>
            <!-- popover back/front title -->
            <span class="field-name <?php echo $field->db_field_name;
                        echo  (isset($fields_from_params['showName_'.$field->db_field_name])
                                || !$layout->lid)?
                               '':
                               ' hide-field-name-'.$field->db_field_name;?>"
            ...
            <div class="main-fields-content main-fields-options">
              ...
              foreach ($layout->fields_list as $field) {
                ...
                if ($ftype == 'decimal_textfield'
                    ...
                    || $ftype == 'text_single_checkbox_onoff'
                    || $ftype == 'text_select_list'){
                    echo show_edite_add_form_field_layout($field, 'search',$fields_from_params,$layout->type,$layout);
                }
              }
