...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/joomlacms2?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/joomlacms2?new_link=true');
  }
}
...
$civicrm_root = 'C:\xampp\htdocs\joomla_cms\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\xampp\htdocs\joomla_cms\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/joomla_cms/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '4034ae38bb32644bbb42ebc1eca3e505');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\xampp\htdocs\joomla_cms\media\civicrm\templates_c/mail.log');
// }
