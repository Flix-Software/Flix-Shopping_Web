           ...
           if(strpos($layout_html,"{|f-calendar_table|}")){
            ...
            if(strpos($layout_html,"{|f-calendar_table|}")){
              ...
              if(isset($layout_params['calendar_layout_params']['fields']['access_'.$field->db_field_name])
                    ...
                    && !checkAccess_cck($layout_params['calendar_layout_params']['fields']['access_'.$field->db_field_name], $user->groups, $layout->fk_eid, 'fields')){
              ...
              ob_start();
                echo '<'.$shell_tag . '  class="'.$custom_class.'" ' . $offset_animation . '>';
          ...
          if(isset($layout_params['fields']['calendar_month_year_published']) 
            ...
            if(strpos($layout_html,"{|f-calendar_month_year|}")){
              ...
              ?>
                ...
                <select style="<?php echo $hideMouth.";".$field_styling?>"  name="month<?php echo $showLayModId?>" class="inputbox <?php echo $custom_class?>" <?php echo $offset_animation; ?> onChange="form.submit()">
                ...
                <select style="<?php echo $hideYear.';'.$field_styling;?>" name="year<?php echo $showLayModId?>" class="inputbox <?php echo $custom_class?>"  <?php $offset_animation; ?> onChange="form.submit()">
              ...
              foreach ($layout_params['views']['show_request_layout'] as $key => $value) {
               ...
               if($php_result){
                    ...
                    if(strpos($layout_html,"{|l-".$key."|}")){
                      ...
                      ob_start();
                      echo '<div class="'.$custom_class.'" ' . $offset_animation . ' ' .$field_styling.'>';
