...
class com_eventgalleryInstallerScript
{
    ...
    */
    function preflight( /** @noinspection PhpUnusedParameterInspection */$type, $parent ) {
        ...
        if ($dbVersion!= null && version_compare($dbVersion, '3.11.16_2020-05-31', 'gt')) {
            $msg = "Downgrades are not supported. Please install the same or a newer version. Current version: " . $dbVersion . '. I tried to install database version 3.11.16_2020-05-31';
    ...
    private function updateDatabase($fixSchemaOnly) {
        ...
        if (!$fixSchemaOnly) {
            ...
            JFactory::getApplication()->enqueueMessage('Event Gallery 3.11.8 installed successfully.'." Updated the database schema from $currentVersion to $targetVersion");
