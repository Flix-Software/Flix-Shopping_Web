...
//  $showSearchOptions[] = JHTML::_('select.option','0','Hide');
  ...
  $showSearchOptions[] = JHTML::_('select.option','0','Hide');
    ...
    if(isset($fields_from_params['fields'][$fName."_field_type"]) && $fields_from_params['fields'][$fName."_field_type"] == "rent_from"){
        $showSearchOptions[] = JHTML::_('select.option','1','Rent from');
    }

    if(isset($fields_from_params['fields'][$fName."_field_type"]) && $fields_from_params['fields'][$fName."_field_type"] == "rent_to"){
        $showSearchOptions[] = JHTML::_('select.option','1','Rent to');
    }

    if(!isset($fields_from_params['fields'][$fName."_field_type"]) || $fields_from_params['fields'][$fName."_field_type"] == "default"){
