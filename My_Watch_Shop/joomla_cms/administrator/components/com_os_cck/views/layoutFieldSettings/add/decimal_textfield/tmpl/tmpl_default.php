...
$field_type = (isset($lParams[$fName.'_field_type'])) ? $lParams[$fName.'_field_type'] : 'number';
...
$field_type_option = array();
$field_type_option[] = JHTML::_('select.option','number','Number field');
$field_type_option[] = JHTML::_('select.option','price','Price field');
$field_type_option[] = JHTML::_('select.option','quantity','Quantity of goods');
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_DIGITS")?><i title="<?php echo JText::_("COM_OS_CCK_LABEL_DIGITS_DESC")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_NUMBER_FIELD_TYPE")?> <i title="<?php echo JText::_("COM_OS_CCK_LABEL_NUMBER_FIELD_TYPE_DESC")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i></label>
        <?php echo JHTML::_('select.genericlist', $field_type_option,  'fi_'. $fName .'_field_type', '','value', 'text',$field_type)?>
    </div>
    -->
    <div>
