...
$field_allowed_value = $params->get("allowed_value", "off\non");
...
$default_value = (isset($lParams[$fName.'_default_value'])) ? $lParams[$fName.'_default_value'] : 0;
...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        ...
        <input type="radio" name="fi_<?php echo $fName?>_default_value"  <?php echo $default_value?'checked':''?> value="1">On
        <input type="radio" name="fi_<?php echo $fName?>_default_value"  <?php echo $default_value?'':'checked'?> value="0">Off
    </div>
    <div>
