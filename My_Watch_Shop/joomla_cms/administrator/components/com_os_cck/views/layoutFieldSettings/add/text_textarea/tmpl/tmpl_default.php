...
<div id="options-field-<?php echo $fName?>">
    ...
    <div>
        <label><?php echo JText::_("COM_OS_CCK_LABEL_SHOW_FIELD_REQUIRED")?>
            <i title="<?php echo JText::_("COM_OS_CCK_TEXTAREA_REQUIRED_EDITOR")?>" class="glyphicon glyphicon-info-sign date_tooltip"></i>
        </label>
