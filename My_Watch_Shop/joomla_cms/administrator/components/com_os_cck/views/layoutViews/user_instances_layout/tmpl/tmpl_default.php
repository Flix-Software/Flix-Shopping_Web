...
$user_map->label = JText::_("COM_OS_CCK_USER_INSTANCES_UNIQUE_FIELD_MAP");
$user_map->db_field_name = 'user_map';
$user_map->field_type = 'instances_map';
$user_map->description = 'Map for user';

$user_order_by = new stdClass();
$user_order_by->label = JText::_("COM_OS_CCK_USER_INSTANCES_UNIQUE_FIELD_CAT_ORDERING");
$user_order_by->db_field_name = 'user_order_by';
$user_order_by->field_type = 'order_by';
$user_order_by->description = 'User Order by block for user';

$user_pagination = new stdClass();
$user_pagination->label = JText::_("COM_OS_CCK_USER_INSTANCES_UNIQUE_FIELD_PAGINATION");
$user_pagination->db_field_name = 'joom_pagination';
$user_pagination->field_type = 'pagination';
$user_pagination->description = 'Pagination block for this layout';

$user_alphabetical = new stdClass();
$user_alphabetical->label = JText::_("COM_OS_CCK_USER_INSTANCES_UNIQUE_FIELD_ALPHABETICAL");
$user_alphabetical->db_field_name = 'joom_alphabetical';
$user_alphabetical->field_type = 'alphabetical';
$user_alphabetical->description = 'Alphabetical pagination block for this layout';



$unique_fields = array($user_map, $user_order_by,$user_pagination, $user_alphabetical);
//end
...
<!-- layout notice -->
<?php 
  noticeLinkToDocLayout('user_instances_layout', 'User instances layout', 'http://ordasoft.com/News/OS-CCK-Documentation/cck-term-explanation.html#Show user');
?>
<!-- /layout notice -->
        ...
        <div id="options-tab-1">
          <div id="fields-options-accordion">
            ...
            <div class="main-fields-content main-fields-options">
              <?php
              foreach ($unique_fields as $field) {
                  //require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'user_instances_layout', 'fieldUniq');
              ...
              if(isset($layout_params['views']['show_request_layout'])){
                foreach ($layout_params['views']['show_request_layout'] as $key => $value) {
                  require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'user_instances_layout', 'layoutOptions');
                }
              }
              if(count($layout_params['unique_fields'])){
                foreach ($layout_params['unique_fields'] as $key => $custom_options){
                  //require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'user_instances_layout', 'customField');
