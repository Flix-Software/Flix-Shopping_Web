...
$all_instance_map->field_type = 'instances_map';
...
$all_instance_order_by->field_type = 'order_by';
...
$all_instance_pagination->field_type = 'pagination';
...
$all_instance_alphabetical->field_type = 'alphabetical';
            ...
            <div class="main-fields-content">
              ...
              <div class="category-options g_custom">
                <div class="category-options">
                  ...
                  <span><?php  echo $layout->resolition_one;?></span>
                </div>
