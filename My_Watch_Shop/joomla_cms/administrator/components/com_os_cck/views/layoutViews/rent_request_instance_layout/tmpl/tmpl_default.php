...
<?php
        ...
        for ($i = 0; $i < count($fields); $i++) {
          ...
          if($field->published == "1" && stripos($field->db_field_name, 'price') === false){ ?>
          <!-- block for field -->
            <div class="field-block">
              <div>
                <?php
        ...
        <div id="options-tab-1">
          <div id="fields-options-accordion">
            ...
            <div class="main-fields-content main-fields-options">
              <?php
              foreach ($unique_fields as $field) {
                //require getLayoutPathCCK::getAdminLayoutViewPath('com_os_cck', 'rent_request_instance_layout', 'fieldUniq');
           ...
           <h3><?php echo JText::_("COM_OS_CCK_STYLING_LABEL_ACCORDION_FIELDS_MAIN_OPTIONS") ?></h3>
            <div class="main-fields-content">
              ...
              <div class="category-options">
                ...
                <?php echo JHTML::_('select.genericlist',$layout->price_per_period, 'vi_price_per_period',
                    'size="1" class="inputbox" ', 'value', 'text', $layout->price_per_period_val);?>
              </div>
                <?php } ?> 
