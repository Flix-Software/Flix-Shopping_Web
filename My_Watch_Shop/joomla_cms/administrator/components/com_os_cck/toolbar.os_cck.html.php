...
//**************   begin for manage reviews   *********************
    static function MENU_MANAGE_REVIEW()
    {
        ...
        {
            mosMenuBar_cckext::publishList('publish_reviews');
        }

        if (JFactory::getUser()->authorise('unpublish_reviews', 'com_os_cck'))
        {
            mosMenuBar_cckext::unpublishList('unpublish_reviews');
            mosMenuBar_cckext::spacer();
        }
...
//**************   end for manage reviews   ***********************
    ...
    static function MENU_COUPONS()
    {
        //mosMenuBar_cckext::startTable();
        mosMenuBar_cckext::editList('edit_coupon', "Edit", true);
        if (JFactory::getUser()->authorise('publish_coupon', 'com_os_cck'))
        {
            mosMenuBar_cckext::publishList('publish_coupon');
        }

        if (JFactory::getUser()->authorise('unpublish_coupon', 'com_os_cck'))
        {
            mosMenuBar_cckext::unpublishList('unpublish_coupon');
            mosMenuBar_cckext::spacer();
        }

        if (JFactory::getUser()->authorise('new_coupon', 'com_os_cck'))
        {
            mosMenuBar_cckext::addNew('new_coupon', JText::_('COM_OS_CCK_HEADER_ADD'));
            mosMenuBar_cckext::spacer();
            mosMenuBar_cckext::deleteList('You confirm remove coupon ?', 'remove_coupon');
            mosMenuBar_cckext::spacer();
        }
    ...
    static function MENU_EDIT_COUPONS()
    {
        mosMenuBar_cckext::startTable();
        mosMenuBar_cckext::save('save_coupon');
        mosMenuBar_cckext::spacer();
        mosMenuBar_cckext::cancel('coupons');
        mosMenuBar_cckext::endTable();
    }
