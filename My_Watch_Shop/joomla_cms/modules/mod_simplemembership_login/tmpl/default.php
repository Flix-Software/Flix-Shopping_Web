...
function sms_login_submitbutton(pressbutton) {
    ...
    var login = document.getElementById('modlgn-username').value;
    var pass = document.getElementById('modlgn-passwd').value;
    ...
    if (xhr.status != 200) {
      ...
      alert( xhr.status + ': ' + xhr.statusText ); 
        ...
        if(xhr.responseText == '"success"'){
            ...
            document.getElementById('modlgn-username').style.borderColor = 'red';
            document.getElementById('modlgn-passwd').style.borderColor = 'red';
