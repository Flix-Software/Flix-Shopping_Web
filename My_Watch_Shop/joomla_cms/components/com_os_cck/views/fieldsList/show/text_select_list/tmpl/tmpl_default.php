...
$tag = isset($layout_params['fields']['field_tag_' . $fName]) ? $layout_params['fields']['field_tag_' . $fName] : 'span';

$value = (isset($value[0]->data))?$value[0]->data : '';
?>

<<?php echo $tag; ?> <?php if(isset($layout_params['fields']['description_'.$fName]) && $layout_params['fields']['description_'.$fName]=='on' && !empty($layout_params['fields'][$fName.'_tooltip']))
        {?>
