...
if($fParams['type'] == 1){?>
    <input <?php echo $field_styling?> class="<?php echo $custom_class?>" <?php echo $offset_animation; ?> type="checkbox" name="os_cck_search_<?php echo $fName?>" checked="checked"  value="on">
    <?php
