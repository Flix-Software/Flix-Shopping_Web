...
<div <?php echo $layout_params['field_styling']?> class="<?php echo $layout_params['custom_class']?>" <?php echo $offset_animation; ?> >
  <?php
  if($field_from_params[$fName.'_map_hide_map'] == 'false'){?>
    <script type="text/javascript">
        function initialize_<?php echo $field_id?>() {
            ...
            function codeAddress() {
                ...
                var address
                if (document.getElementById("<?php echo $fName?>_map_address") !== null){
                    address = address + document.getElementById("<?php echo $fName?>_map_address").value + " ";
                }
                if (document.getElementById("<?php echo $fName?>_map_country") !== null){
                    address = address + document.getElementById("<?php echo $fName?>_map_country").value + " ";
                } 
                if (document.getElementById("<?php echo $fName?>_map_region") !== null){
                    address = address + document.getElementById("<?php echo $fName?>_map_region").value + " ";
                } 
                if (document.getElementById("<?php echo $fName?>_map_city") !== null){
                    address = address + document.getElementById("<?php echo $fName?>_map_city").value + " ";
                } 
                if (document.getElementById("<?php echo $fName?>_map_zip_code") !== null){
                    address = address + document.getElementById("<?php echo $fName?>_map_zip_code").value + " ";
                } 
    ...
    if($field_from_params[$fName.'_map_hide_map'] == 'false'){
      if($field_from_params[$fName.'_map_as_show'] != 'true'){?>
        <input class="<?php $field->db_field_name; ?>" type="button" onclick="initialize_<?php echo $field_id ?>.codeAddress(); return;" value="Find on map">
        <?php 
      }?>
